...
import { Shap, Size, TextSize } from '../../modal/Demand';

@Component({
  selector: 'app-demand-post',
  templateUrl: './demand-post.component.html',
  styleUrls: ['./demand-post.component.css']
})
export class DemandPostComponent {
